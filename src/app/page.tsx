          ...
          <div className="grid grid-rows-2 grid-flow-col lg:max-w-[80%] items-center gap-6 container px-6 md:px-8 mt-12">
            <div className="max-w-[250px]">
              <div className="mb-5 flex">
                <Upload className="mr-4 text-[#006AFF]" />
            ...
            <div className="max-w-[250px]">
              <div className="mb-5 flex">
                <Video className="rotate-180 mr-4 text-[#006AFF]" />
            ...
            <div className="max-w-[250px]">
              <div className="mb-5 flex">
                <Radio className="mr-4 text-[#006AFF]" />
            ...
            <div className="max-w-[250px]">
              <div className="mb-5 flex">
                <CircleDollarSign className="mr-4 text-[#006AFF]" />
            ...
            <div className="max-w-[250px]">
              <div className="mb-4 flex">
                <MonitorSmartphone className="mr-4 text-[#006AFF]" />
